...
$(CC) $(CFLAGS) -I$(LUA_INCDIR) -shared vendor/fen_random.c -o .lrbuild/fen_random.so
   ...
   install = {
      lua = {
         ...
         ["fen.util.path"] = ".lrbuild/util/path/init.lua",
         ["fen.util.path.backend"] = ".lrbuild/util/path/backend.lua",
         ["fen.util.path.backends.posix"] = ".lrbuild/util/path/backends/posix.lua",
         ["fen.util.process"] = ".lrbuild/util/process/init.lua",
         ["fen.util.process.backend"] = ".lrbuild/util/process/backend.lua",
         ["fen.util.process.backends.posix"] = ".lrbuild/util/process/backends/posix.lua",
         ["fen.util.random"] = ".lrbuild/util/random/init.lua",
         ["fen.util.random.backend"] = ".lrbuild/util/random/backend.lua",
         ["fen.util.random.backends.native"] = ".lrbuild/util/random/backends/native.lua",
         ["fen.util.redact"] = ".lrbuild/util/redact.lua",
