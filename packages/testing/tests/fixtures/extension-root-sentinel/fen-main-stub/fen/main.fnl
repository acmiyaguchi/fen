;; Stand-in for fen.main used by flake.nix#fenOverlaySmoke. When this
;; dir is passed via --dev-path and packages/testing/tests/fixtures/extension-root-sentinel/
