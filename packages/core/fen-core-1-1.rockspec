...
[ -f .lrbuild/.fen-precompiled ] || "${FENNEL:-fennel}" "${FEN_WORKSPACE:?set FEN_WORKSPACE to build this rock without fen}/scripts/build/fennel-build.fnl" --lrbuild
   ...
   install = {
      lua = {
         ...
         ["fen.core.extensions.loader.discover"] = ".lrbuild/core/extensions/loader/discover/init.lua",
         ["fen.core.extensions.loader.discover.backend"] = ".lrbuild/core/extensions/loader/discover/backend.lua",
         ["fen.core.extensions.loader.discover.backends.posix"] = ".lrbuild/core/extensions/loader/discover/backends/posix.lua",
         ...
         ["fen.core.storage"] = ".lrbuild/core/storage/init.lua",
         ["fen.core.storage.backend"] = ".lrbuild/core/storage/backend.lua",
         ["fen.core.storage.backends.default"] = ".lrbuild/core/storage/backends/default.lua",
