...
printf 'return "%s"\n' "${FEN_VERSION:-unknown}" > .lrbuild/version.lua
   ...
   install = {
      lua = {
         ...
         ["fen.reload_request"] = ".lrbuild/reload_request.lua",
         ["fen.run_state"] = ".lrbuild/run_state.lua",
         ["fen.runtime"] = ".lrbuild/runtime.lua",
         ["fen.runtime_recovery"] = ".lrbuild/runtime_recovery.lua",
         ["fen.script_runner"] = ".lrbuild/script_runner.lua",
         ["fen.session_cli"] = ".lrbuild/session_cli.lua",
         ["fen.session_control"] = ".lrbuild/session_control.lua",
