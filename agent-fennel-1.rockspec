...
build = {
   ...
   modules = {
      ...
      ["agent-fennel.providers.openai_codex_responses"]  = "dist/providers/openai_codex_responses.lua",
      ...
      ["agent-fennel.auth.openai_codex"]                 = "dist/auth/openai_codex.lua",
      ["agent-fennel.util.base64"]                       = "dist/util/base64.lua",
