...
;; @doc fen.extensions.builtin_commands.state.extensions.visible?
;; kind: data
;; signature: boolean
...
;; @doc fen.extensions.builtin_commands.state.extensions.selected-name
;; kind: data
...
;; @doc fen.extensions.builtin_commands.state.extensions.cached-rows
;; kind: data
