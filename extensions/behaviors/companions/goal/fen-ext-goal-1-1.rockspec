package = "fen-ext-goal"
version = "1-1"
rockspec_format = "3.0"

source = {
   url = "git+https://github.com/acmiyaguchi/fen.git",
   dir = "fen/extensions/behaviors/companions/goal",
}
...
[ -f .lrbuild/.fen-precompiled ] || "${FENNEL:-fennel}" "${FEN_WORKSPACE:?set FEN_WORKSPACE to build this rock without fen}/scripts/build/fennel-build.fnl" --lrbuild
   ...
   install = {
      lua = {
         ["fen.extensions.goal"] = ".lrbuild/extensions/goal/init.lua",
         ["fen.extensions.goal.manifest"] = ".lrbuild/extensions/goal/manifest.lua",
         ["fen.extensions.goal.state"] = ".lrbuild/extensions/goal/state.lua",
      },
   },
}
