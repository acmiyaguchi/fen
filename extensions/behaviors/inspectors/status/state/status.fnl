...
;; @doc fen.extensions.status.state.status.visible?
;; kind: data
;; signature: boolean
...
;; @doc fen.extensions.status.state.status.cached-rows
;; kind: data
