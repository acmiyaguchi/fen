...
;; @doc fen.extensions.queue.state.queue.visible?
;; kind: data
;; signature: boolean
...
;; @doc fen.extensions.queue.state.queue.cached-rows
;; kind: data
