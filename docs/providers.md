...
For the ChatGPT/Codex subscription provider, fen queries the private ChatGPT backend `GET /backend-api/codex/models?client_version=0.155.0` catalog when OAuth credentials are configured and keeps list-visible models marked `supported_in_api`.
